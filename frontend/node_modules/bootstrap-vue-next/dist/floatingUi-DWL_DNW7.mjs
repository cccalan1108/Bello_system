...
import { p as useMouse$1, k as onClickOutside } from "./index-Cr5Qd2ql.mjs";
        ...
        createVNode(_sfc_main$1, {
          ...
          default: withCtx(() => [
            unref(renderRef) || unref(contentShowing) ? (openBlock(), createBlock(Transition, mergeProps({ key: 0 }, unref(transitionProps), {
              ...
              default: withCtx(() => [
                withDirectives(createElementVNode("div", mergeProps({ id: unref(computedId) }, _ctx.$attrs, {
                  ref: "_element",
...
const BPopover = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-08119d6e"]]);
...
//# sourceMappingURL=floatingUi-DWL_DNW7.mjs.map
