import { defineComponent, mergeModels, useSlots, useModel, ref, useTemplateRef, computed, watch, openBlock, createBlock, unref, withCtx, Transition, mergeProps, withDirectives, createElementVNode, createElementBlock, Fragment, normalizeClass, renderSlot, normalizeProps, guardReactiveProps, createTextVNode, toDisplayString, createCommentVNode, vShow, nextTick } from "vue";
import { l as useBreakpoints, o as onKeyStroke, c as useFocus, m as breakpointsBootstrapV5 } from "./index-Cr5Qd2ql.mjs";
import { u as useSafeScrollLock, a as useActivatedFocusTrap } from "./useSafeScrollLock-DUIeABf3.mjs";
...
const BOffcanvas = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-fdff9e9e"]]);
export {
  BOffcanvas as B
};
//# sourceMappingURL=BOffcanvas-BsLF8xkS.mjs.map
