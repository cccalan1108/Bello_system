import { defineComponent, computed, openBlock, createBlock, resolveDynamicComponent, unref, normalizeClass, withCtx, renderSlot, useAttrs, createElementBlock, mergeProps, createVNode, withModifiers, mergeModels, useModel, useTemplateRef, createTextVNode, toDisplayString } from "vue";
...
import { _ as _sfc_main$6 } from "./BLink.vue_vue_type_script_setup_true_lang-Bq3DKvYC.mjs";
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("li", mergeProps({ class: liClasses.value }, _ctx.wrapperAttrs), [
        createVNode(_sfc_main$5, mergeProps(attrs, {
          id: unref(props).id,
...
//# sourceMappingURL=BNavText.vue_vue_type_script_setup_true_lang-Btv7RBfu.mjs.map
