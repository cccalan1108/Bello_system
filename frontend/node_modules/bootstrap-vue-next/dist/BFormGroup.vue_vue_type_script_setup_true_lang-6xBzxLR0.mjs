import { defineComponent, useSlots, ref, provide, computed, useTemplateRef, openBlock, createBlock, resolveDynamicComponent, unref, normalizeClass, withCtx, createVNode, renderSlot, createTextVNode, toDisplayString, createCommentVNode, createElementBlock, Fragment, normalizeProps, mergeProps } from "vue";
...
import { u as upperFirst } from "./stringUtils-BCx12BQM.mjs";
import { u as useStateClass } from "./useStateClass-BGbSLWFN.mjs";
import { u as useId } from "./useId-c2wnQbyL.mjs";
import { f as createReusableTemplate } from "./index-Cr5Qd2ql.mjs";
      ...
      return openBlock(), createBlock(resolveDynamicComponent(isFieldset.value ? "fieldset" : "div"), {
        ...
        default: withCtx(() => [
          ...
          isHorizontal.value ? (openBlock(), createBlock(_sfc_main$5, { key: 0 }, {
            ...
            createVNode(unref(LabelContentTemplate).reuse),
            !isHorizontal.value && unref(props).floating ? (openBlock(), createElementBlock("div", _hoisted_1, [
              renderSlot(_ctx.$slots, "default", {
                id: unref(computedId),
                ariaDescribedby: null,
                descriptionId: unref(descriptionId),
...
//# sourceMappingURL=BFormGroup.vue_vue_type_script_setup_true_lang-6xBzxLR0.mjs.map
